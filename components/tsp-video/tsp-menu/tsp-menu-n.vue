			...
			<view class="vodMenu"
				...
				<view class="vodMenu-top">
					...
					<view class="follow" @click="followBtn(index)" v-if="!item.followReally"
						...
						<image src="/static/icon/gou.png" mode="" class="follow-guanzhu guanzhu-gou"
							v-if="followShow == 1 || followShow == 2"></image>
						<image src="/static/icon/guanzhu.png" mode="" class="follow-guanzhu"
				...
				<view class="fabulous" @click="JumpBtn(2)" style="position: relative;padding-top: 5rpx;">
					...
					<view class="fabulous-image" @click="fabulousBtn" :ref="'likeRef'+index">
						<image src="/static/icon/selectTaoxin.png" mode="" class="fabulous-image"
